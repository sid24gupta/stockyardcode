...
def json_img(payload):
    scoring_uri = "http://adc5d16f-1286-4cb9-a213-e6f7212cb571.southeastasia.azurecontainer.io/score"
...
def stockyardprocessed(request):
    ...
    """account_name = 'farmsteestoragec94960c0b'
    ...
    path = "https://farmsteestoragec94960c0b.blob.core.windows.net/test/images/test513.jpeg"
    ...
    for i in range(3):
        ...
        """if(file_name!=latest):
        root_path = 'C:/Users/sravya.s.dhulipala/Downloads/FarmSteel'
        dir_name = 'images'
